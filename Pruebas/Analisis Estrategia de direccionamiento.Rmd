...
source("D:/Documentos/INAP/Rutina_encuestras/funcion_disposicion.R")
```
...
codigos <- scan(file = "D:/Documentos/INAP/Rutina_encuestras/Pruebas/ED Dedoose 01 Est_Dir.txt",
                what = character(), sep = "\n", fileEncoding = "UTF-8",
                allowEscapes = T)
```
...
El primer paso para seleccionar la mejor transformación consistió en calcular la *medida de proporcionalidad global* sobre los datos originales[^1], ésta dió como resultado **29.33**.
