...
estr <- scan("C:/Users/Lorena/Desktop/Rutina_encuestras/Códigos Dedoose/Dimensión Direccionamiento estratégico/PRUEBA 2/ED.txt",
             what = character(), sep = "\n", fileEncoding = "UTF-8", allowEscapes = T)

innov <- scan("C:/Users/Lorena/Desktop/Rutina_encuestras/Códigos Dedoose/Dimensión Direccionamiento estratégico/PRUEBA 2/BI.txt",
              what = character(), sep = "\n", fileEncoding = "UTF-8", allowEscapes = T)

clima <- scan("C:/Users/Lorena/Desktop/Rutina_encuestras/Códigos Dedoose/Dimensión Direccionamiento estratégico/PRUEBA 2/CO.txt",
              what = character(), sep = "\n", fileEncoding = "UTF-8", allowEscapes = T)

mecan <- scan("C:/Users/Lorena/Desktop/Rutina_encuestras/Códigos Dedoose/Dimensión Direccionamiento estratégico/PRUEBA 2/MC.txt",
              what = character(), sep = "\n", fileEncoding = "UTF-8", allowEscapes = T)

gestion <- scan("C:/Users/Lorena/Desktop/Rutina_encuestras/Códigos Dedoose/Dimensión Direccionamiento estratégico/PRUEBA 2/GPR.txt",
                what = character(), sep = "\n", fileEncoding = "UTF-8", allowEscapes = T)
